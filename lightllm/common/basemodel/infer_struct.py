...
class InferStateInfo:
    ...
    def __init__(self):
        ...
        # per-(real-request) previous-step accept count, used by the hybrid-MTP
        # GDN verify + conv kernels as the canonical read offset
        # (num_accepted_tokens - 1). None outside hybrid MTP verify.
