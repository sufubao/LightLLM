...
class Req(ctypes.Structure):
    ...
    _fields_ = [
        ...
        ("linear_att_cpu_state_page", ctypes.c_int64),
    ...
    def init(
        ...
        self.linear_att_cpu_state_page = -1
        if args.enable_cpu_cache:
            ...
            self.token_hash_page_len_list.fill([args.cpu_cache_token_page_size * (i + 1) for i in range(page_num)])
