...
class StartArgs:
    ...
    target_vocab_topk_sampling: Optional[int] = field(default=None, metadata={"choices": [16, 32, 64, 128, 256, 512]})
    draft_vocab_topk_sampling: Optional[int] = field(default=None, metadata={"choices": [16, 32, 64, 128, 256, 512]})
