...
class StartArgs:
    ...
    shm_req_max_size: Optional[int] = field(default=None)
    ...
    prefill_cudagraph_capture_shapes: Optional[List[str]] = field(default=None)
    ...
    idle_batch_coalesce_quiet_time: float = field(default=0.0)
    idle_batch_coalesce_max_wait: float = field(default=0.0)
