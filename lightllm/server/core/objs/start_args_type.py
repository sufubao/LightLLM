...
class StartArgs:
    ...
    disable_pd_node_decode_admission: bool = field(default=False)
    pd_node_decode_admission_queue_size: Optional[int] = field(default=None)
    pd_node_decode_admission_timeout: float = field(default=5.0)
