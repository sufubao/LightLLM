...
class MultiLevelKVCacheManager:
    def __init__(
        ...
        self.is_linear_att_mixed_model = is_linear_att_mixed_model(args.model_dir)
    ...
    def _match_linear_att_tail(self, req: Req, pages: List[int]):
    ...
    def _handle_group_req_multi_cache_match(self, group_req_indexes: GroupReqIndexes, start_time: float):
        ...
        for req in reqs:
            ...
            self._match_linear_att_tail(req, finded_page_indexes)
